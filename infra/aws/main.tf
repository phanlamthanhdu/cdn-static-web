...
resource "aws_s3_bucket_public_access_block" "static_web_privacy" {
...
resource "aws_s3_bucket_policy" "allow_cloudfront" {
  ...
  depends_on = [aws_s3_bucket_public_access_block.static_web_privacy]
}
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  default_cache_behavior {
    ...
    target_origin_id = "S3-${aws_s3_bucket.static_web.bucket}"
